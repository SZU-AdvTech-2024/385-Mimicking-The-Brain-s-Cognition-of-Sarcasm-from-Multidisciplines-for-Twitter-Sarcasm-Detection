...
```
conda activate llm
cd /home/p/Documents/Codes/tweeter_sarcasm_detect/ablation/A2
CUDA_VISIBLE_DEVICES=1 python train.py --lr 0.001
我的电脑有4张gpu，CUDA_VISIBLE_DEVICES的值从0到3轮询。

t1 
CUDA_VISIBLE_DEVICES=1 python train.py --lr 0.001
t2 
CUDA_VISIBLE_DEVICES=1 python train.py --lr 0.0002