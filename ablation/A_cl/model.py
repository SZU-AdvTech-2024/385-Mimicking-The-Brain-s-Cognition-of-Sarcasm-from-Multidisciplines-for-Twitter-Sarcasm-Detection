...
class AttentionWeightedFusion(nn.Module):
    def __init__(self, feature_dim):
        ...
        print('fusion: twt, caps AttentionWeightedFusion')
...
class MyModel(nn.Module):
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        self.fusion = AttentionWeightedFusion(in_channels)
    ...
    def forward(self, images, twts, caps, attrs):
        ...
        v1, v2 = self.sa1(twt_feats), self.sa2(caps_feats) #, self.sa1(caps_feats), self.sa1(attrs_feats)
        v1, v2, v_a = self.fusion(v1, v2)
        # stacked_tensor = torch.stack((v_a, v_b, v_c))
        #
        # # 对堆叠后的张量沿着第一个维度求均值
